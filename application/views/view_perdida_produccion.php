...
<?php 
	...
	echo '];</script>';
	echo '<script>var legend = "Pérdida"; color="orange";</script>';
?>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Ingreso de Pérdida en Producción</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" action="<?= base_url(); ?>perdidaProduccion/ingreso" method="POST" data-parsley-validate="true">	
						...
						<div class="form-group">
							<label class="col-md-3 control-label ui-sortable">Banco</label>
							<div class="col-md-9 ui-sortable">
		...
		<div class="col-md-10 col-sm-6">
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Resumen MENSUAL</h4>
				</div>
				<div class="panel-body">
   ...
   <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="POST" action="<?=base_url()?>perdidaProduccion/eliminar">
...
<script>
	$(document).ready(function() {
		...
		$("#LIperdida").addClass("active");$("#LIenproduccion").addClass("active");
