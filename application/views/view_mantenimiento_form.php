...
<div id="content" class="content">
	...
	<div class="panel panel-inverse no-print">				
			<div class="panel-body">
				<ul class="list-inline pull-right" style="margin:0;">
					...
					<li><a href="<?= base_url(); ?>mantenimiento/imprimir/<?=$id_solicitud?>"><i class="fa fa-print fa-3x"></i></a></li>
				</ul>
			</div>
		</div>
	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			<form class="form-horizontal form-bordered" action="<?= base_url(); ?>mantenimiento/ingresoUpdate" method="POST" data-parsley-validate="true">	
				...
				<div class="form-group">
					...
					?>
						...
						<input name="id_detalle[]" type="hidden" id="id_detalle" value="<?=$detalle->id_mantenimiento?>">
						<div class="form-group m-r-10" style="margin-top: 80px;">
							<input type="checkbox" <?=$chk?> name="inputVerificado[]" value="<?=$detalle->id_mantenimiento?>"/>
							<label> <?=$detalle->descripcion?> | Días: <?=$detalle->dias?> </label>
							<br>
							<br>
							<div class="input-group date" id="datepicker-autoClose<?=$detalle->id_mantenimiento?>" data-date-format="dd-mm-yyyy" style="padding:0;">
