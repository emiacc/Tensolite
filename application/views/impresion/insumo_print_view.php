...
<body onload="imprimir()">
    <div class="conteiner">
        ...
        <section>
            ...
            <table class="rwd_auto fontsize">
                <thead>
                    <tr>
                        <th>Nº de Ordene</th>
                        <th>Descripción de la necesidad de Insumos</th>
                        <th>24 Hs</th>
                        <th>7 Dias</th>
                        <th>30 Dias</th>
                    </tr>
            ...
            <table class="rwd_auto fontsize">
                ...
                <tbody>
                    <tr>
                        <td style="width:25%;">Solicita Supervisor</td>
                        <td style="width:25%;"></td>
                        <td style="width:25%;">Recepta Supervisor de Pañol</td>
                        <td style="width:25%;"></td>
                    </tr>
        ...
        <div class="borde"><h2>Cumplimiento de Insumos o Materiales Solicitados</h2></div>
