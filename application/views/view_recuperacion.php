...
<div id="content" class="content">
	...
	<div class="panel panel-inverse">
		<div class="panel-heading">
			...
			<h4 class="panel-title">Ingreso Recuperación</h4>
		</div>
		<div class="panel-body">
			<form class="form-inline" action="<?= base_url(); ?>recuperacion/ingreso" method="POST" data-parsley-validate="true">	
	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			<form class="form-inline text-center" action="<?= base_url(); ?>recuperacion" method="POST" data-parsley-validate="true">					
				<div class="form-group m-r-10">
